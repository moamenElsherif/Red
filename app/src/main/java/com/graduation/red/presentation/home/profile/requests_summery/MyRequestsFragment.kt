...
import com.graduation.red.databinding.FragmentActiveRequestsBinding
...
@AndroidEntryPoint
class MyRequestsFragment : BaseFragment<FragmentActiveRequestsBinding>() ,RequestSummeryListener{
    override val layoutRes: Int
        get() = R.layout.fragment_active_requests
    ...
    private fun getMyRequestList() {
        ...
        lifecycleScope.launchWhenStarted {
            ...
            document.get().addOnSuccessListener {
                ...
                val requestIdList = result?.createdRequestList ?: emptyList()
                hideLoading()
